...
<script>
  module.exports = {
    ...
    methods: {
      ...
      addParametr: function() {
        for(var i = 0; i < this.goods.length; i++){
          this.$set(this.goods[i], "toCompare", false);
        }
      }
...
var goods = [
    ...
    categoryId: 10,
		photo: "img/good2.jpg",
		name: "11111Bluefilters New Line RO-9PAF",
  ...
  { 
    ...
    tankVolume: 4,
    specialDiferentes: "Универсальный",
    weight: 4,
    pressure: "2,4-5",
	},
  { 
